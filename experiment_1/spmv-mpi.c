...
//    printf("estimated time for once %f\n", (float) estimated_time);
    ...
    timer t;
    timer_start(&t);
    //TO-DO modify for MPI program wherever necessary
...
int main(int argc, char** argv)
{
    ...
    //TO-DO write reduction logic so that all answers of y[i] are summed up in the root node
